        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-1">{stats.fundingVolume}</h3>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-1">{stats.maDeals} Deals</h3>
              <p className="text-xs text-green-500 mt-1 flex items-center">
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-1">{stats.trendingSector}</h3>
              <p className="text-xs text-green-500 mt-1 flex items-center">
                <TrendingUp className="w-3 h-3 mr-1" />
                High Conviction
              </p>
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h3 className={`text-2xl font-bold mt-1 ${stats.sentiment === "Bullish" ? "text-green-600" : "text-red-600"}`}>{stats.sentiment}</h3>
